...
def main(config_file):
    ...
    run = wandb.init(project=os.getenv("WANDB_PROJECT"), config=args_config, name=args_config["training_args"]['run_name'])
    ...
    for epoch in tqdm(range(args_config["training_args"]["epochs"])):
        ...
        for step, train_batch in enumerate(train_loader):
            ...
            run.log({"train/loss": loss, "epoch": epoch, "step": global_step}, step=global_step)
