...
class BaseAutoEncoderWithInitsDeep(BaseModel):
    def __init__(self, model_name='base_auto_encoder', init_method=None):
        super(BaseAutoEncoderWithInitsDeep, self).__init__(model_name)
        ...
        self.decoder = nn.Sequential(
            ...
            nn.ReLU(),
            nn.ConvTranspose2d(128, 3, kernel_size=7, stride=2, padding=3, output_padding=1),
            nn.Sigmoid(),
        )
