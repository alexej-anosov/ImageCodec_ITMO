...
class BaseAutoEncoderWithInitsBottleneckActivation(BaseModel):
    def __init__(self, model_name='base_auto_encoder', init_method=None, activation=None):
        super(BaseAutoEncoderWithInitsBottleneckActivation, self).__init__(model_name)
